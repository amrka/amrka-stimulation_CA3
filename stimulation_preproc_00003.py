...
# anatomical images
templates_anat = {
    'anat': '/media/amr/Amr_4TB/Work/stimulation/Data_CA3/{subject_id}/Anat_{subject_id}_bet.nii.gz'
}
...
# functional runs
templates_func = {
    'bold': '/media/amr/Amr_4TB/Work/stimulation/Data_CA3/{subject_id}/Stim_{subject_id}_??_{frequency_id}_{session_id}.nii.gz',
...
def coreg(bold_image):
  ...
  # only to force the pipeline to run brain extraction first
    ...
    img = '/media/amr/Amr_4TB/Work/stimulation/Data_CA3/{0}/Anat_{0}_bet.nii.gz'.format(subj_no)
