...
session_list = ['run001', 'run002', 'run003', 'run004', 'run005', 'run006', 'run007', 'run008']
...
output_dir = 'Stimulation_1st_level_OutputDir_%_change_CA3'
working_dir = 'Stimulation_1st_level_WorkingDir_%_change_CA3'

stimulation_1st_level_percent_change = Workflow(name='stimulation_1st_level_percent_change_CA3')
...
templates = {
    ...
    'preproc_img': '/home/in/aeed/Work/stimulation/Stimulation_Preproc_OutputDir_CA3/preproc_img/{frequency_id}_{session_id}_subj_{subject_id}/afni_2d_smoothed_maths_filt_maths.nii.gz',
    'bold_brain': '/home/in/aeed/Work/stimulation/Stimulation_Preproc_OutputDir_CA3/bold_brain/{frequency_id}_{session_id}_subj_{subject_id}/Stim_{subject_id}_??_{frequency_id}_{session_id}_roi_masked.nii.gz',
    'bold_mask': '/home/in/aeed/Work/stimulation/Data_CA3/{subject_id}/EPI_{subject_id}_Mask.nii.gz',

    'tem2anat': '/home/in/aeed/Work/stimulation/Stimulation_Preproc_WorkingDir_CA3/stimulation_preproc_CA3/_subject_id_{subject_id}/reg_T1_2_temp/transformInverseComposite.h5',
    'ant2func': '/home/in/aeed/Work/stimulation/Stimulation_Preproc_WorkingDir_CA3/stimulation_preproc_CA3/_frequency_id_{frequency_id}_session_id_{session_id}_subject_id_{subject_id}/coreg/bold_2_anat_sub-{subject_id}0GenericAffine.mat',
    'anat_img': '/home/in/aeed/Work/stimulation/Stimulation_Preproc_WorkingDir_CA3/stimulation_preproc_CA3/_subject_id_{subject_id}/biasfield_correction_anat/Anat_{subject_id}_bet_corrected.nii.gz'
