...
subject_list = ['024', '025', '026', '027', '028', '038',
                '040', '041', '042', '051', '052', '053',
                '054', '055', '059', '060', '061', '079',
                '081']


output_dir = 'Stimulation_2nd_level_OutputDir_05Hz_CA3'
working_dir = 'Stimulation_2nd_level_WorkingDir_05Hz_CA3'

stimulation_2nd_level = Workflow(name='stimulation_2nd_level_05Hz_CA3')
...
templates = {
    ...
    'anat_brain':  '/home/in/aeed/Work/stimulation/Data_CA3/{subject_id}/Anat_{subject_id}_bet.nii.gz',
    'mask_brain':  '/home/in/aeed/Work/stimulation/Data_CA3/{subject_id}/Anat_{subject_id}_Mask.nii.gz',
    'anat_2_temp_trans':  '/home/in/aeed/Work/stimulation/Stimulation_Preproc_OutputDir_CA3/anat_2_temp_transformations/subj_{subject_id}/transformComposite.h5',

    # ==========================================================================================================================================================

    'func_2_anat_trans_05Hz_r1':  """/home/in/aeed/Work/stimulation/Stimulation_Preproc_WorkingDir_CA3/stimulation_preproc_CA3/_frequency_id_05Hz_session_id_run001_subject_id_{subject_id}/coreg/bold_2_anat_sub-{subject_id}0GenericAffine.mat""",
    'func_2_anat_trans_05Hz_r2':  """/home/in/aeed/Work/stimulation/Stimulation_Preproc_WorkingDir_CA3/stimulation_preproc_CA3/_frequency_id_05Hz_session_id_run002_subject_id_{subject_id}/coreg/bold_2_anat_sub-{subject_id}0GenericAffine.mat""",
    'func_2_anat_trans_05Hz_r3':  """/home/in/aeed/Work/stimulation/Stimulation_Preproc_WorkingDir_CA3/stimulation_preproc_CA3/_frequency_id_05Hz_session_id_run003_subject_id_{subject_id}/coreg/bold_2_anat_sub-{subject_id}0GenericAffine.mat""",

    # ==========================================================================================================================================================

    'cope1_05Hz_r1': '/home/in/aeed/Work/stimulation/Stimulation_1st_level_OutputDir_CA3/copes_1st_level/05Hz_run001_subj_{subject_id}/cope1.nii.gz',
    'cope1_05Hz_r2': '/home/in/aeed/Work/stimulation/Stimulation_1st_level_OutputDir_CA3/copes_1st_level/05Hz_run002_subj_{subject_id}/cope1.nii.gz',
    'cope1_05Hz_r3': '/home/in/aeed/Work/stimulation/Stimulation_1st_level_OutputDir_CA3/copes_1st_level/05Hz_run003_subj_{subject_id}/cope1.nii.gz',

    # ==========================================================================================================================================================

    'varcope1_05Hz_r1': '/home/in/aeed/Work/stimulation/Stimulation_1st_level_OutputDir_CA3/varcopes_1st_level/05Hz_run001_subj_{subject_id}/varcope1.nii.gz',
    'varcope1_05Hz_r2': '/home/in/aeed/Work/stimulation/Stimulation_1st_level_OutputDir_CA3/varcopes_1st_level/05Hz_run002_subj_{subject_id}/varcope1.nii.gz',
    'varcope1_05Hz_r3': '/home/in/aeed/Work/stimulation/Stimulation_1st_level_OutputDir_CA3/varcopes_1st_level/05Hz_run003_subj_{subject_id}/varcope1.nii.gz',

    # ==========================================================================================================================================================
    "percent_change_r1": '/home/in/aeed/Work/stimulation/Stimulation_1st_level_WorkingDir_%_change_CA3/stimulation_1st_level_percent_change_CA3/_frequency_id_05Hz_session_id_run001_subject_id_{subject_id}/get_percent_change_timeseries/percent_change_timeseries.txt',
    "percent_change_r2": '/home/in/aeed/Work/stimulation/Stimulation_1st_level_WorkingDir_%_change_CA3/stimulation_1st_level_percent_change_CA3/_frequency_id_05Hz_session_id_run002_subject_id_{subject_id}/get_percent_change_timeseries/percent_change_timeseries.txt',
    "percent_change_r3": '/home/in/aeed/Work/stimulation/Stimulation_1st_level_WorkingDir_%_change_CA3/stimulation_1st_level_percent_change_CA3/_frequency_id_05Hz_session_id_run003_subject_id_{subject_id}/get_percent_change_timeseries/percent_change_timeseries.txt',
...
def copes1_2_anat_func(fixed, cope1_05Hz_r1, cope1_05Hz_r2, cope1_05Hz_r3, func_2_anat_trans_05Hz_r1, func_2_anat_trans_05Hz_r2, func_2_anat_trans_05Hz_r3, mask_brain):
    import os
    import re
    import nipype.interfaces.ants as ants
    import nipype.interfaces.fsl as fsl
    ...
    copes1 = [cope1_05Hz_r1, cope1_05Hz_r2, cope1_05Hz_r3]
    trans = [func_2_anat_trans_05Hz_r1, func_2_anat_trans_05Hz_r2, func_2_anat_trans_05Hz_r3]
    ...
    for i in range(len(copes1)):
        ...
        ants_apply.inputs.output_image = 'cope1_2_anat_05Hz_r{0}.nii.gz'.format(i+1)

        ants_apply.run()

        copes1_2_anat.append(os.path.abspath('cope1_2_anat_05Hz_r{0}.nii.gz'.format(i+1)))

        dof = fsl.ImageMaths()
        dof.inputs.in_file = 'cope1_2_anat_05Hz_r{0}.nii.gz'.format(i+1)
        dof.inputs.op_string = '-mul 0 -add 147 -mas'
        dof.inputs.in_file2 = mask_brain
        dof.inputs.out_file = 'FEtdof_t1_2_anat_05Hz_r{0}.nii.gz'.format(i+1)

        dof.run()

        FEtdof_t1_2_anat.append(os.path.abspath('FEtdof_t1_2_anat_05Hz_r{0}.nii.gz'.format(i+1)))

    merge = fsl.Merge()
    merge.inputs.dimension = 't'
    merge.inputs.in_files = copes1_2_anat
    merge.inputs.merged_file = 'copes1_2_anat_05Hz.nii.gz'
    merge.run()

    merge.inputs.in_files = FEtdof_t1_2_anat
    merge.inputs.merged_file = 'dofs_t1_2_anat_05Hz.nii.gz'
    merge.run()

    copes1_2_anat = os.path.abspath('copes1_2_anat_05Hz.nii.gz')
    dofs_t1_2_anat = os.path.abspath('dofs_t1_2_anat_05Hz.nii.gz')
...
copes1_2_anat_func = Node(name='copes1_2_anat_func',
                          interface=Function(input_names=['fixed',
                                                          ...
                                                          'cope1_05Hz_r2',
                                                          'cope1_05Hz_r3',
                                                          'func_2_anat_trans_05Hz_r1',
                                                          'func_2_anat_trans_05Hz_r2',
                                                          'func_2_anat_trans_05Hz_r3',
                                                          'mask_brain'],
...
def varcopes1_2_anat_func(fixed, varcope1_05Hz_r1, varcope1_05Hz_r2, varcope1_05Hz_r3, func_2_anat_trans_05Hz_r1, func_2_anat_trans_05Hz_r2, func_2_anat_trans_05Hz_r3):
    import os
    import re
    import nipype.interfaces.ants as ants
    import nipype.interfaces.fsl as fsl
    ...
    varcopes1 = [varcope1_05Hz_r1, varcope1_05Hz_r2, varcope1_05Hz_r3]
    trans = [func_2_anat_trans_05Hz_r1, func_2_anat_trans_05Hz_r2, func_2_anat_trans_05Hz_r3]
    ...
    for i in range(len(varcopes1)):
        ...
        ants_apply.inputs.reference_image = fixed
        ants_apply.inputs.transforms = transform
        ants_apply.inputs.output_image = 'varcope1_2_anat_05Hz_r{0}.nii.gz'.format(i+1)

        ants_apply.run()

        varcopes1_2_anat.append(os.path.abspath('varcope1_2_anat_05Hz_r{0}.nii.gz'.format(i+1)))

    merge = fsl.Merge()
    merge.inputs.dimension = 't'
    merge.inputs.in_files = varcopes1_2_anat
    merge.inputs.merged_file = 'varcopes1_2_anat_05Hz.nii.gz'
    merge.run()

    varcopes1_2_anat = os.path.abspath('varcopes1_2_anat_05Hz.nii.gz')
...
def mean_timeseries_2nd_level(percent_change_r1, percent_change_r2, percent_change_r3):
    ...
    np.savetxt('mean_ts_05Hz_2nd_level.txt', ts_2nd_level)
...
stimulation_2nd_level.connect([
    ...
    (selectfiles, copes1_2_anat_func, [('anat_brain', 'fixed'),
                                       ('cope1_05Hz_r1', 'cope1_05Hz_r1'),
                                       ('cope1_05Hz_r2', 'cope1_05Hz_r2'),
                                       ('cope1_05Hz_r3', 'cope1_05Hz_r3'),
                                       ('func_2_anat_trans_05Hz_r1',
                                        'func_2_anat_trans_05Hz_r1'),
                                       ('func_2_anat_trans_05Hz_r2',
                                        'func_2_anat_trans_05Hz_r2'),
    ...
    (selectfiles, varcopes1_2_anat_func, [('anat_brain', 'fixed'),
                                          ('varcope1_05Hz_r1', 'varcope1_05Hz_r1'),
                                          ('varcope1_05Hz_r2', 'varcope1_05Hz_r2'),
                                          ('varcope1_05Hz_r3', 'varcope1_05Hz_r3'),
                                          ('func_2_anat_trans_05Hz_r1', 'func_2_anat_trans_05Hz_r1'),
                                          ('func_2_anat_trans_05Hz_r2', 'func_2_anat_trans_05Hz_r2'),
                                          ('func_2_anat_trans_05Hz_r3', 'func_2_anat_trans_05Hz_r3')]),
    ...
    (cope1_2ndlevel_2_template, datasink, [
        ('output_image', 'cope1_2ndlevel_2_template')]),
    (varcope1_2ndlevel_2_template, datasink, [
        ('output_image', 'varcope1_2ndlevel_2_template')]),
