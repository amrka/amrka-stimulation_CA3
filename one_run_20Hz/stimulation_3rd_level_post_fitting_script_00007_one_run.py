...
output_dir  = 'output_stimulation_proc_3rd_level_post_fitting_CA3_one_run'
working_dir = 'workingdir_stimulation_proc_3rd_level_post_fitting_CA3_one_run'


proc_3rd_level = Workflow (name = 'proc_3rd_level_CA3_one_run')
...
templates = {
          ...
          'zstat'           :  '/media/amr/Amr_4TB/Work/stimulation/stimulation_3rd_level_CA3_one_run/{frequencies}/flameo/{zstats}.nii.gz',
...
def smooth_est(zstat):
     ...
     res4d = '/media/amr/Amr_4TB/Work/stimulation/stimulation_3rd_level_CA3_one_run/20Hz/flameo/res4d.nii.gz'
...
def cluster_zstats(zstat, volume, dlh):
        ...
        cope = '/media/amr/Amr_4TB/Work/stimulation/stimulation_3rd_level_CA3_one_run/20Hz/flameo/cope{0}.nii.gz'.format(cope_no)
