...
output_dir  = 'Stimulation_2nd_level_OutputDir_20Hz_CA3_one_run'
working_dir = 'Stimulation_2nd_level_WorkingDir_20Hz_CA3_one_run'

stimulation_2nd_level = Workflow(name = 'stimulation_2nd_level_20Hz_CA3_one_run')
...
stimulation_2nd_level.connect([
              ...
              (selectfiles, merge_trans, [('anat_2_temp_trans','in1'),
                                          ('func_2_anat_trans_20Hz_r1','in2')]),

              (selectfiles, cope1_2_template, [('cope1_20Hz_r1','input_image')]),
              (merge_trans, cope1_2_template, [('out','transforms')]),



              (selectfiles, varcope1_2_template, [('varcope1_20Hz_r1', 'input_image')]),
