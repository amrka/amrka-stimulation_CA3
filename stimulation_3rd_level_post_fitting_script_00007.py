...
output_dir = 'output_stimulation_proc_3rd_level_post_fitting_CA3'
working_dir = 'workingdir_stimulation_proc_3rd_level_post_fitting_CA3'


proc_3rd_level = Workflow(name='proc_3rd_level_CA3')
...
templates = {
    ...
    'zstat':  '/home/in/aeed/Work/stimulation/stimulation_3rd_level_CA3/{frequencies}/flameo/{zstats}.nii.gz',
...
def smooth_est(zstat):
    ...
    if zstat[-25:-21] == '05Hz':
        res4d = '/home/in/aeed/Work/stimulation/stimulation_3rd_level_CA3/05Hz/flameo/res4d.nii.gz'
        smooth_est.inputs.dof = 7
    elif zstat[-25:-21] == '10Hz':
        res4d = '/home/in/aeed/Work/stimulation/stimulation_3rd_level_CA3/10Hz/flameo/res4d.nii.gz'
        smooth_est.inputs.dof = 9
    elif zstat[-25:-21] == '20Hz':
        res4d = '/home/in/aeed/Work/stimulation/stimulation_3rd_level_CA3/20Hz/flameo/res4d.nii.gz'
        smooth_est.inputs.dof = 9
    elif zstat[-25:-21] == '40Hz':
        res4d = '/home/in/aeed/Work/stimulation/stimulation_3rd_level_CA3/40Hz/flameo/res4d.nii.gz'
        smooth_est.inputs.dof = 9
...
def cluster_zstats(zstat, volume, dlh):
    ...
    if zstat[-25:-21] == '05Hz':
        cope = '/home/in/aeed/Work/stimulation/stimulation_3rd_level_CA3/05Hz/flameo/cope{0}.nii.gz'.format(
            cope_no)
    elif zstat[-25:-21] == '10Hz':
        cope = '/home/in/aeed/Work/stimulation/stimulation_3rd_level_CA3/10Hz/flameo/cope{0}.nii.gz'.format(
            cope_no)
    elif zstat[-25:-21] == '20Hz':
        cope = '/home/in/aeed/Work/stimulation/stimulation_3rd_level_CA3/20Hz/flameo/cope{0}.nii.gz'.format(
            cope_no)
    elif zstat[-25:-21] == '40Hz':
        cope = '/home/in/aeed/Work/stimulation/stimulation_3rd_level_CA3/40Hz/flameo/cope{0}.nii.gz'.format(
            cope_no)
