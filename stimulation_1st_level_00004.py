...
templates = {
    ...
    'preproc_img': '/media/amr/Amr_4TB/Work/stimulation/Stimulation_Preproc_OutputDir_CA3/preproc_img/{frequency_id}_{session_id}_subj_{subject_id}/afni_2d_smoothed_all_maths_filt_maths.nii.gz',
