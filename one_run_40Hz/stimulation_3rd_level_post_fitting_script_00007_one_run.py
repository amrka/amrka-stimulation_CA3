...
def smooth_est(zstat):
     ...
     res4d = '/media/amr/Amr_4TB/Work/stimulation/stimulation_3rd_level_CA3_one_run/40Hz/flameo/res4d.nii.gz'
...
def cluster_zstats(zstat, volume, dlh):
        ...
        cope = '/media/amr/Amr_4TB/Work/stimulation/stimulation_3rd_level_CA3_one_run/40Hz/flameo/cope{0}.nii.gz'.format(cope_no)
