...
output_dir = 'Stimulation_2nd_level_OutputDir_40Hz_CA3'
working_dir = 'Stimulation_2nd_level_WorkingDir_40Hz_CA3'

stimulation_2nd_level = Workflow(name='stimulation_2nd_level_40Hz_CA3')
...
templates = {
    ...
    'func_2_anat_trans_40Hz_r1':  """/home/in/aeed/Work/stimulation/Stimulation_Preproc_WorkingDir_CA3/stimulation_preproc_CA3/_frequency_id_40Hz_session_id_run001_subject_id_{subject_id}/coreg/bold_2_anat_sub-{subject_id}0GenericAffine.mat""",
    'func_2_anat_trans_40Hz_r2':  """/home/in/aeed/Work/stimulation/Stimulation_Preproc_WorkingDir_CA3/stimulation_preproc_CA3/_frequency_id_40Hz_session_id_run002_subject_id_{subject_id}/coreg/bold_2_anat_sub-{subject_id}0GenericAffine.mat""",
    'func_2_anat_trans_40Hz_r3':  """/home/in/aeed/Work/stimulation/Stimulation_Preproc_WorkingDir_CA3/stimulation_preproc_CA3/_frequency_id_40Hz_session_id_run003_subject_id_{subject_id}/coreg/bold_2_anat_sub-{subject_id}0GenericAffine.mat""",

    # ==========================================================================================================================================================

    'cope1_40Hz_r1': '/home/in/aeed/Work/stimulation/Stimulation_1st_level_OutputDir_CA3/copes_1st_level/40Hz_run001_subj_{subject_id}/cope1.nii.gz',
    'cope1_40Hz_r2': '/home/in/aeed/Work/stimulation/Stimulation_1st_level_OutputDir_CA3/copes_1st_level/40Hz_run002_subj_{subject_id}/cope1.nii.gz',
    'cope1_40Hz_r3': '/home/in/aeed/Work/stimulation/Stimulation_1st_level_OutputDir_CA3/copes_1st_level/40Hz_run003_subj_{subject_id}/cope1.nii.gz',

    # ==========================================================================================================================================================

    'varcope1_40Hz_r1': '/home/in/aeed/Work/stimulation/Stimulation_1st_level_OutputDir_CA3/varcopes_1st_level/40Hz_run001_subj_{subject_id}/varcope1.nii.gz',
    'varcope1_40Hz_r2': '/home/in/aeed/Work/stimulation/Stimulation_1st_level_OutputDir_CA3/varcopes_1st_level/40Hz_run002_subj_{subject_id}/varcope1.nii.gz',
    'varcope1_40Hz_r3': '/home/in/aeed/Work/stimulation/Stimulation_1st_level_OutputDir_CA3/varcopes_1st_level/40Hz_run003_subj_{subject_id}/varcope1.nii.gz',

    # ==========================================================================================================================================================
    "percent_change_r1": '/home/in/aeed/Work/stimulation/Stimulation_1st_level_WorkingDir_%_change_CA3/stimulation_1st_level_percent_change_CA3/_frequency_id_40Hz_session_id_run001_subject_id_{subject_id}/get_percent_change_timeseries/percent_change_timeseries.txt',
    "percent_change_r2": '/home/in/aeed/Work/stimulation/Stimulation_1st_level_WorkingDir_%_change_CA3/stimulation_1st_level_percent_change_CA3/_frequency_id_40Hz_session_id_run002_subject_id_{subject_id}/get_percent_change_timeseries/percent_change_timeseries.txt',
    "percent_change_r3": '/home/in/aeed/Work/stimulation/Stimulation_1st_level_WorkingDir_%_change_CA3/stimulation_1st_level_percent_change_CA3/_frequency_id_40Hz_session_id_run003_subject_id_{subject_id}/get_percent_change_timeseries/percent_change_timeseries.txt',
...
def copes1_2_anat_func(fixed, cope1_40Hz_r1, cope1_40Hz_r2, cope1_40Hz_r3, func_2_anat_trans_40Hz_r1, func_2_anat_trans_40Hz_r2, func_2_anat_trans_40Hz_r3, mask_brain):
    import os
    import re
    import nipype.interfaces.ants as ants
    import nipype.interfaces.fsl as fsl
    ...
    copes1 = [cope1_40Hz_r1, cope1_40Hz_r2, cope1_40Hz_r3]
    trans = [func_2_anat_trans_40Hz_r1, func_2_anat_trans_40Hz_r2, func_2_anat_trans_40Hz_r3]
...
def varcopes1_2_anat_func(fixed, varcope1_40Hz_r1, varcope1_40Hz_r2, varcope1_40Hz_r3, func_2_anat_trans_40Hz_r1, func_2_anat_trans_40Hz_r2, func_2_anat_trans_40Hz_r3):
    import os
    import re
    import nipype.interfaces.ants as ants
    import nipype.interfaces.fsl as fsl
    ...
    varcopes1 = [varcope1_40Hz_r1, varcope1_40Hz_r2, varcope1_40Hz_r3]
    trans = [func_2_anat_trans_40Hz_r1, func_2_anat_trans_40Hz_r2, func_2_anat_trans_40Hz_r3]
