...
for slice_no in {474,436,417,398,360,341,322,284};do
    ...
    ${out_dir}/A_${frequency}_rambmc_CA3.nii.gz --cmap blue-lightblue     --displayRange 3.1  7
...
for slice_no in {474,436,417,398,360,341,322,284};do
    ...
    ${rambmc} --displayRange 50 210  \
    ${out_dir}/B_${frequency}_rambmc_CA3.nii.gz --cmap blue-lightblue     --displayRange 3.1  7
