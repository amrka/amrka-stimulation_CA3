...
###############################################################################################################################
    ...
    plt.savefig(
        "/media/amr/Amr_4TB/Dropbox/thesis/stimulation/CA3_A_{0}_%_change_ts.svg".format(frequency), format='svg')
    plt.close()
...
#========================================================================================================0
    ...
    plt.savefig(
        "/media/amr/Amr_4TB/Dropbox/thesis/stimulation/CA3_B_{0}_%_change_ts.svg".format(frequency), format='svg')
    plt.close()
...
#========================================================================================================0
    ...
    plt.savefig(
        "/media/amr/Amr_4TB/Dropbox/thesis/stimulation/CA3_Both_{0}_%_change_ts.svg".format(frequency), format='svg')
    plt.close()
    print('##################### Done plotting combined plot #####################')
#========================================================================================================0
plot_av_percent_change('05Hz')
