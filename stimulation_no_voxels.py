...
templates = {
    ...
    'thresh_zstat':  '/media/amr/Amr_4TB/Work/stimulation/Stimulation_2nd_level_WorkingDir_{frequencies}_CA3/stimulation_2nd_level_{frequencies}_CA3/_subject_id_{subjects}/cluster_copes1/thresh_zstat1.nii.gz',
    'anat_2_temp': '/media/amr/Amr_4TB/Work/stimulation/Stimulation_Preproc_WorkingDir_CA3/stimulation_preproc_CA3/_subject_id_{subjects}/reg_T1_2_temp/transformComposite.h5'
}
...
no_voxels_CA3.write_graph(graph2use='colored', format='png', simple_form=True)

# no_voxels_CA3.run(plugin='SLURM', plugin_args={
#     'dont_resubmit_completed_jobs': True, 'max_jobs': 50})

no_voxels_CA3.run(plugin='MultiProc', plugin_args={'n_procs': 16})
